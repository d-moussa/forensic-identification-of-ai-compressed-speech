...
base_path = "data/"
train_paths_model = [f"ai_compressed_data/tsp/lyra/bw_{x}/" for x in [3200, 6000, 9200]]
train_paths_orig = [*["uncompressed_data/tsp_partial_2s_24kHz/"]*len(train_paths_model)]
